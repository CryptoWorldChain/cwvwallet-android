...
public class LSettingItem extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        mUnderLine = (View) mView.findViewById(R.id.under_line);
        ...
        mRightIcon_check = (AppCompatCheckBox) mView.findViewById(R.id.right_check);
        mRightIcon_switch = (SwitchCompat) mView.findViewById(R.id.right_switch);
    }

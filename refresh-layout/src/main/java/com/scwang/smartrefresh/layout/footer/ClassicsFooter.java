...
public class ClassicsFooter extends RelativeLayout implements RefreshFooter {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTitleText.setText(context.getString(R.string.smart_refresh_footer_pullup));
    ...
    public int onFinish(RefreshLayout layout, boolean success) {
        if (!mLoadmoreFinished) {
            ...
            mProgressView.setVisibility(GONE);
            if (success) {
                mTitleText.setText(context.getString(R.string.smart_refresh_footer_finish));
            } else {
                mTitleText.setText(context.getString(R.string.smart_refresh_footer_failed));
            }
    ...
    public boolean setLoadmoreFinished(boolean finished) {
        if (mLoadmoreFinished != finished) {
            ...
            if (finished) {
                mTitleText.setText(context.getString(R.string.smart_refresh_footer_allloaded));
            } else {
                mTitleText.setText(context.getString(R.string.smart_refresh_footer_pullup));
            }
            if (mProgressDrawable != null) {
...
//                    restoreRefreshLayoutBackground();
                ...
                case LoadReleased:
                    mArrowView.setVisibility(GONE);
                    mTitleText.setText(context.getString(R.string.smart_refresh_footer_loading));
                    break;
                case ReleaseToLoad:
                    mTitleText.setText(context.getString(R.string.smart_refresh_footer_release));
                    mArrowView.animate().rotation(0);
//                    replaceRefreshLayoutBackground(refreshLayout);
                    break;
                case Refreshing:
                    mTitleText.setText(context.getString(R.string.smart_refresh_footer_refreshing));
                    mProgressView.setVisibility(GONE);
                    mArrowView.setVisibility(GONE);
                    break;
            }

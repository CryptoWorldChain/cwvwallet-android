...
//    public static String REFRESH_HEADER_LASTTIME = "'Last update' M-d HH:mm";
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mTitleText.setText(context.getString(R.string.smart_refresh_header_pulldown));
        ...
        if (isInEditMode()) {
            ...
            mTitleText.setText(context.getString(R.string.smart_refresh_header_refreshing));
        } else {
    ...
    public int onFinish(RefreshLayout layout, boolean success) {
        ...
        mProgressView.setVisibility(GONE);
        if (success) {
            mTitleText.setText(context.getString(R.string.smart_refresh_header_finish));
            if (mLastTime != null) {
                setLastUpdateTime(new Date());
            }
        } else {
            mTitleText.setText(context.getString(R.string.smart_refresh_header_failed));
        }
...
//                restoreRefreshLayoutBackground();
            ...
            case ReleaseToRefresh:
                mTitleText.setText(context.getString(R.string.smart_refresh_header_release));
...
//                replaceRefreshLayoutBackground(refreshLayout);
            ...
            case Loading:
                ...
                mTitleText.setText(context.getString(R.string.smart_refresh_header_loading));
                break;
        }
    }
    //</editor-fold>
    ...
    public ClassicsHeader setLastUpdateTime(Date time) {
        mLastTime = time;
        mLastUpdateText.setText(context.getString(R.string.smart_refresh_header_lasttime) + mFormat.format(time));
    ...
    public ClassicsHeader setTimeFormat(DateFormat format) {
        mFormat = format;
        if (mLastTime != null) {
            mLastUpdateText.setText(context.getString(R.string.smart_refresh_header_lasttime) + mFormat.format(mLastTime));
        }
        return this;
    }
